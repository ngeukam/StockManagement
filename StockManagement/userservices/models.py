...
class Users(AbstractUser):
    ...
    role=models.CharField(max_length=50,blank=True,null=True,default='Server',choices=(('Admin','Admin'),('Supplier','Supplier'), ('HeadChef','HeadChef'), ('Manager','Manager'),('Server','Server'), ('Customer','Customer'),('Staff','Staff')))
