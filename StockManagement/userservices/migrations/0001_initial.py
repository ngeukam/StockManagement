    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(blank=True, choices=[('Admin', 'Admin'), ('Supplier', 'Supplier'), ('HeadChef', 'HeadChef'), ('Manager', 'Manager'), ('Server', 'Server'), ('Customer', 'Customer'), ('Staff', 'Staff')], default='Admin', max_length=50, null=True)),
